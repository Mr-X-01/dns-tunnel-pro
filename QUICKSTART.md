...
- **Домен**: Введите ваш домен (например: `tunnel.example.com`)
- **Пароль**: Установите пароль администратора (по умолчанию: `admin123`)
...
⚠️ **ВАЖНО**: Сразу смените пароль в настройках!
